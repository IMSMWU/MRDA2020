...
* Check the usability on mobile devices using the preview option (make sure the "Mobile frinedly" option is checked).
:::
...
For pitching, revision and submission of your final questionnaire, please consult this section LINK \@ref(tab:mytable_sub).
